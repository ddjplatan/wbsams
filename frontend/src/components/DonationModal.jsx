          ...
          <Col>
            <Form>
              <FloatingLabel className="mb-2" controlId="donor" label="Donor">
                <Form.Control type="text" name="donor" value={donation.donor} onChange={donationHandleChange} />
              </FloatingLabel>
              <FloatingLabel className="mb-2" controlId="donationType" label="Donation Type">
                <Form.Control type="text" name="donationType" value={donation.donationType} onChange={donationHandleChange} />
              </FloatingLabel>
